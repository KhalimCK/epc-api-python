...
import epc_api_python.exceptions as exceptions
...
class EpcClient:
    ...
    def __init__(
        ...
        """
        To authenticate with this epc_api_python, an auth token is generated by Base64-encoding the string
        ...
        :param auth_token:      authorisation token for the epc_api_python. The authorisation token is generated from a users
                                epc_api_python key and email address, however the authorisation token can be supplied directly
        :param user_email:      Should be the email address that has been used to sign up to the epc_api_python with
        :param api_key:         The epc_api_python key which is emailed to you after signing up to the epc_api_python
...
class EpcResource:
    ...
    def _validate_params(params):
        ...
        try:
            ...
            raise exceptions.InvalidApiParameter(
                "Invalid parameter passed, check epc_api_python documentation for valid parameters"
            )
        pass
    ...
    def search(self, params: dict = None, size: int = None, offset_from: int = None):
        ...
        :param params:          dictionary of parameters that are passed to the /search url. More information on
                                valid parameter values can be found in the epc_api_python documentation at
                                https://epc.opendatacommunities.org/docs/api/domestic for the domestic epc_api_python and
                                https://epc.opendatacommunities.org/docs/api/non-domestic for the non-domestic epc_api_python
