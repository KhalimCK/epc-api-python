...
class EpcClient:
    ...
    def __init__(
        ...
        :param auth_token:      authorisation token for the api. The authorisation token is generated from a users
                                api key and email address, however the authorisation token can be supplied directly
        :param user_email:      Should be the email address that has been used to sign up to the api with
        :param api_key:         The api key which is emailed to you after signing up to the api
