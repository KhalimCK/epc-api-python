...
class EpcClient:
    ...
    def __init__(self, auth_token=None, user_email=None, api_key=None, accept=None):
        """
        ...
        if accept is not None:
            ...
            if accept not in self.valid_accept:
                raise exceptions.InvalidApiParameter(
                    "Invalid value supplied for accept, given %s valid values are %s" % (accept, self.valid_accept)
                )
            self._accept = accept
        else:
